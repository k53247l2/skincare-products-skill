...
[![版本](https://img.shields.io/badge/版本-2.2-blue)](https://github.com)
...
- **文献引用模式** — 医学/安全问题：问题拆分 (Claim Extraction)、证据路由 (指南/PubMed/法规)、结构化证据卡、5 段式答案 + 可点击来源链接
...
- **禁止伪对应引用** — 不能把成分文献写成产品临床验证
- **禁止低等级证据当实锤** — 体外研究 ≠ 人体临床有效；机制引用必须携带明确限制条件
- **三类结论强制分离** — 每次回答区分文献支持、配方推断和不确定部分
- **安全问题必须引安全法规源** — 孕期、长期使用、致痘性等问题必须路由至 SCCS/CIR/FDA/NMPA
- **没证据就说没证据** — "暂无直接临床证据"永远好过编造引用
...
```markdown
━━━ ① 核心结论 ━━━
该产品大概率适合油痘肌作为长期维稳精华。主活性为壬二酸，
烟酰胺辅助控油修护。非"猛药型"祛痘产品，更适合管理痘印。

━━━ ③ 文献支持的结论 ━━━
- 壬二酸对轻中度痤疮和炎症后色沉有较明确文献支持，可作为长期管理活性之一 [C1][C2]
- 烟酰胺偏辅助控油、减轻炎症和支持屏障，通常不是"猛药型祛痘成分" [C3]

━━━ ④ 配方推断与不确定项 ━━━
- 实际壬二酸浓度未知
- "适不适合你"属于配方推断，不等于该商品有临床验证

━━━ ⑤ 参考来源 ━━━
[C1] 壬二酸在痤疮/痘印中的应用综述 (2023, review)
来源: PubMed  |  链接: https://pubmed.ncbi.nlm.nih.gov/xxxxxxxx/

[C2] AAD 痤疮管理指南 (2024, guideline)
来源: JAAD  |  链接: https://www.jaad.org/...
```
